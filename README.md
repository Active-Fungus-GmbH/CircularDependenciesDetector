...
Compatible version of Unreal Engine : **5.5**

In order to compile the plugin you need to :
- Create an Unreal Engine **C++ project**.
- Copy the plugin root folder _(the folder that contains the file CircularDependenciesDetector.uplugin)_ in your project like this "**YourProject/Plugins/CircularDependenciesDetector**".
